...
monster.voices = {
	...
	{ text = "I protect the pride!", yell = false },
...
monster.attacks = {
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_HOLYDAMAGE, minDamage = -50, maxDamage = -350, range = 3, shootEffect = CONST_ANI_HOLY, target = true },
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_FIREDAMAGE, minDamage = -50, maxDamage = -375, length = 4, spread = 4, effect = CONST_ME_FIREAREA, target = false },
}
