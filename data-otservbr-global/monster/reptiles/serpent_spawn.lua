...
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -268 }, -- média das wikis
	{ name = "combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -100, maxDamage = -300, range = 7, shootEffect = CONST_ANI_POISON, target = false },
	...
	{ name = "combat", interval = 2000, chance = 10, type = COMBAT_EARTHDAMAGE, minDamage = -100, maxDamage = -450, length = 8, spread = 3, effect = CONST_ME_POISONAREA, target = false }, -- média das wikis
}
